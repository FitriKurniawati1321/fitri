  ...
  <body class="login-screen">
    ...
    <form method="POST" action="{{ url('auth/login') }}" class="form-login">
        ...
        <div class="login-form-group group">
            ...
            <input type="email" name="email" id="email" class="login-form-group-input" placeholder="Email ..." required>
        </div>
        <div class="login-form-group group">
            <label for="password" class="login-form-group-label">Password</label>
            <input type="password" name="password" id="password" class="login-form-group-input" placeholder="Password" required>
        </div>
